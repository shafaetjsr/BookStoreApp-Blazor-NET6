...
namespace BookStoreApp.Blazor.Server.UI.Services.Base
{
    ...
    public partial class Book
    {
        ...
        [Newtonsoft.Json.JsonProperty("tititle", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
    ...
    {
        [Newtonsoft.Json.JsonProperty("tititle", Required = Newtonsoft.Json.Required.Always)]
        [System.ComponentModel.DataAnnotations.Required(AllowEmptyStrings = true)]
        [System.ComponentModel.DataAnnotations.StringLength(50)]
        public string Tititle { get; set; }
